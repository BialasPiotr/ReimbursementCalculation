...
public class Server {
    ...
    private static final Reimbursement reimbursement = new Reimbursement();
        ...
        private void handlePostRequest(HttpExchange exchange) throws IOException {
            ...
            try {
                if (params.containsKey("receiptType") && params.containsKey("receiptValue")) {
                    ...
                    reimbursement.addReceipt(type, value);
                    ...
                    double total = reimbursement.calculateTotalReimbursement(days, distance);
